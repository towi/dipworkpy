...
- **DipNet evaluator not geography-aware** — DONE (Task 9): evaluator feeds `ConvoyGraph`/`order_geo_info`; triage in `project/doc/DIPNET_CONVOY_TRIAGE.md`. Residual: GEO-010/VIA follow-up (Roadmap #5).
